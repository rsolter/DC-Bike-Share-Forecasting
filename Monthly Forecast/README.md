...
![](Monthly_bike_forecast_files/figure-gfm/Plots-1.png)<!-- -->
...
![](Monthly_bike_forecast_files/figure-gfm/unnamed-chunk-1-1.png)<!-- -->
...
![](Monthly_bike_forecast_files/figure-gfm/Removing%20Seasonality-1.png)<!-- -->
...
![](Monthly_bike_forecast_files/figure-gfm/ACF%20and%20PACF%20plots-1.png)<!-- -->![](Monthly_bike_forecast_files/figure-gfm/ACF%20and%20PACF%20plots-2.png)<!-- -->
...
stationary mean, though the variance does not appear
constant:

![](Monthly_bike_forecast_files/figure-gfm/Searching%20for%20Stationarity:%20Differencing%20Plot-1.png)<!-- -->

-----

Running ACF, PACF plots of the differeced data to see what values for
*q*, *p* would be for an ARIMA
model:

![](Monthly_bike_forecast_files/figure-gfm/Differenced%20ACF-1.png)<!-- -->

The ACF plot shows significant auto-correlations at lags 1,2,8,9,11
(*q*)

![](Monthly_bike_forecast_files/figure-gfm/Differenced%20PACF-1.png)<!-- -->
...
![](Monthly_bike_forecast_files/figure-gfm/Fit%20Evaluation-1.png)<!-- -->
...
![](Monthly_bike_forecast_files/figure-gfm/Auto-Arima-1.png)<!-- -->
...
![](Monthly_bike_forecast_files/figure-gfm/Partition%20and%20Forecast-1.png)<!-- -->
